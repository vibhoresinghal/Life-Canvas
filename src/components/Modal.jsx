...
const Modal = ({ isOpen, onClose, item, onSave, onDelete, onMoveToPast }) => {
                    ...
                    <div className="flex gap-3 pt-4">
                        {item && (
                            <>
                                ...
                                <button onClick={() => { onMoveToPast(item.id); }} className="px-4 py-2 text-neutral-500 hover:text-neutral-700 text-sm font-medium">
                                    Move to Past
                                </button>
                            </>
                        )}
